...
<html lang="en">
    <head>
        ...
        <link href="vendors/plugins/ladda/ladda.min.css" rel="stylesheet" type="text/css"/>
    ...
    <body>
                                ...
                                <div class="card-body">
                                    ...
                                    <form  method="POST" id="signinform">
                                        <div class="input-group mb-3"><span class="input-group-text">
                                            ...
                                            <input class="form-control" type="text" placeholder="Username" required="" id="email">
                                        </div>
        ...
        <script src="vendors/plugins/jquery-3.5.1/jquery-3.5.1.min.js" type="text/javascript"></script>
        <script src="vendors/plugins/jquery-3.5.1/popper.min.js" type="text/javascript"></script>
        <script src="vendors/plugins/ladda/ladda.min.js" type="text/javascript"></script>
        <script src="vendors/plugins/bootstrap/js/bootstrap.min.js" type="text/javascript"></script>
        <script src="vendors/@coreui/coreui/js/coreui.bundle.min.js"></script>
        <script src="vendors/simplebar/js/simplebar.min.js"></script>
        <script src="vendors/plugins/notify.min.js" type="text/javascript"></script>
        <script src="vendors/plugins/sweetalert.js" type="text/javascript"></script>
        <script>
            $(function () {
