        ...
        <div class="card-body">
            <form action="#" method="POST" id="projectform" >
                ...
                <div class="form-footer pt-2  mt-2 border-top text-center">
                    <button type="submit" class="btn btn-outline-success" data-style="expand-right" ><i class="mdi mdi-account-plus-outline"></i>  Add Impact</button>&nbsp;&nbsp;&nbsp;&nbsp;
...
<script>
    $(function () {
        ...
        $("#projectform").on('submit', function (event) {
            ...
            formdata.append('action', "addimpact");
            ...
            $.ajax({
                ...
                success: function (feedback) {
                    ...
                    if (feedback.response === true) {
                        ...
                        swal({
                            title: "Error Generated",
                            text: "Unable to Add Impact of service",
                            icon: "error",
                            button: false,
                            timer: 5000
                        });
