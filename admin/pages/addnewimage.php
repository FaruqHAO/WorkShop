        ...
        <div class="card-body">
            <form action="#" method="POST" id="projectform" >
                ...
                <div class="form-footer pt-2  mt-2 border-top text-center">
                    <button type="submit" class="btn btn-outline-success" data-style="expand-right" ><i class="mdi mdi-account-plus-outline"></i>  Add Image</button>&nbsp;&nbsp;&nbsp;&nbsp;
...
<script>
    $(function () {
            ...
            if (extn === "gif" || extn === "png" || extn === "jpg" || extn === "jpeg") {
                if (filesize <= 521600) {
                    ...
                    swal({
                        ...
                        text: "This Image size is too large",
                        icon: "error",
                        button: true
                    });
                    $('button[type=submit]').attr('disabled', 'disabled');
        ...
        $("#projectform").on('submit', function (event) {
            ...
            formdata.append('action', "addimagegallrey");
