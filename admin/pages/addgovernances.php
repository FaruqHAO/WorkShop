            ...
            <div class="row border-top">
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="position" required="" placeholder="Position Held">
                    </div>
                </div> 

            </div>
            <div class="form-footer pt-2  mt-2 border-top text-center">
                <button type="submit" class="btn btn-outline-success" data-style="expand-right" ><i class="mdi mdi-account-plus-outline"></i>  Add Governance</button>&nbsp;&nbsp;&nbsp;&nbsp;
...
//                Add User to Database
            $.post("process/server.php", {
                action: "addgovances", email: $('#email').val(), title: $('#title').val(),
                fullname: $('#fullname').val(), phonenumber: $('#phonenumber').val(),
                nation: $('#nation').val(), coverartencodedimage: coverartencodedimage,
                commanderylist: $("#commanderylist").val(), position: $("#position").val(),status:'1'
            }, function (feedback) {
                feedback = JSON.parse(feedback);
                if (feedback.response === true) {
                    swal({
                        title: "Successful",
                        text: "Goveranace added",
                        icon: "success",
                        button: true
                    }).then((result) => {
                        pagenav("governance");
                    ...
                    if (feedback.error.length > 0) {
                        ...
                        swal({
                            title: "Error Generated",
                            text: "Governances Could not be added",
                            icon: "error",
                            button: false,
                            timer: 4000
                        });
