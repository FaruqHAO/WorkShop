    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-4"></div>
                <div class="col-4">
                    <button class=" btn btn-primary" id="Addnewimpact">Add New Impact</button>
                </div>
            </div>
        </div>
        <br><br>
...
<script>
    $(function () {
        pagename("Impact of our service");
        $("#Addnewimpact").on("click", function () {
            pagenav("addimpact");
        });
        var workshoplistdatatable;
        var formdata = new FormData();
        formdata.append('action', "fetchallimpact");
        $.ajax({
                                        ...
                                        $.post("process/server.php", {
                                            ...
                                            if (feedback.response === true) {
                                                ...
                                                swal({
                                                    ...
                                                    text: "Unable to Update Impact Details",
                                                    icon: "error",
                                                    button: false,
                                                    timer: 5000
                                                });
...
////                delecting user details
                    $(".deletenews").on("click", function () {
                        ...
                        swal({
                            title: "You are about to delete this Impact of Service?",
                            icon: "warning",
                            buttons: true,
                            dangerMode: true
                        }).then((willDelete) => {
